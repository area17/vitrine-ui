<div
    {{ $attributes->merge(['data-behavior' => $attributes->prepends('Input')])->optimizedMerge(Arr::toCssClasses([$ui('input', 'base'), 's-disabled' => $disabled, 's-error' => $error, 's-readonly' => $readonly])) }}
     {{ $disabled ? 'inert' : '' }}>
