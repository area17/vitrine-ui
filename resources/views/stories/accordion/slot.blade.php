@storybook([
    ...
    'args' => [
        ...
        'id' => '',
        'a11yLabel' => 'Accordion Label',
        'headingLevel' => 3,
        'scrollOnOpen' => false,
        'exclusive' => false,

        // AccordionItem args
        'itemTitle' => 'Cras justo odio, dapibus ac facilisis in',
        'itemIndex' => 0,
        'itemSetFixedHeight' => true,
        'itemIconClosed' => 'plus-32',
        'itemIconOpen' => 'minus-32',
        'itemOpen' => false,
    ],
    'argTypes' => [
        'id' => [
            'description' => 'Unique ID for the accordion. If not provided, it will be generated dynamically.',
            'defaultValue' => ['summary' => ''],
            'control' => 'text',
        ],
        'a11yLabel' => [
            'description' => 'The accessibility label for the accordion component.',
            'defaultValue' => ['summary' => ''],
            'control' => 'text',
        ],
        'headingLevel' => [
            'description' => 'The heading level for the accordion item titles.',
            'defaultValue' => ['summary' => 3],
            'control' => 'number',
        ],
        'scrollOnOpen' => [
            'description' => 'Determines if the page should scroll to the opened accordion item.',
            'defaultValue' => ['summary' => false],
            'control' => 'boolean',
        ],
        'exclusive' => [
            'description' => 'When true, only one accordion item can be open at a time.',
            'defaultValue' => ['summary' => false],
            'control' => 'boolean',
        ],
        ...
        'itemTitle' => [
            ...
            'defaultValue' => ['summary' => 'Accordion Item Title'],
            'control' => 'text',
        ],
        'itemIndex' => [
            'description' => 'Index of the accordion item.',
            'defaultValue' => ['summary' => 0],
            'control' => 'number',
        ],
        'itemSetFixedHeight' => [
            'description' => 'Determines whether the content has a fixed height.',
            'defaultValue' => ['summary' => true],
            'control' => 'boolean',
        ],
        'itemIconClosed' => [
            'description' => 'Icon shown when the accordion item is closed.',
            'defaultValue' => ['summary' => 'plus-32'],
            'control' => 'text',
        ],
        'itemIconOpen' => [
            'description' => 'Icon shown when the accordion item is open.',
            'defaultValue' => ['summary' => 'minus-32'],
            'control' => 'text',
        ],
        'itemOpen' => [
            'description' => 'Determines whether the accordion item is initially open.',
            'defaultValue' => ['summary' => false],
            'control' => 'boolean',
        ],
    ]
        ...
        <x-vui-accordion>
            @foreach ($items as $item)
                <x-vui-accordion-item
                        ...
                        :index="$loop->index"
                        :setFixedHeight="$itemSetFixedHeight"
                        :iconClosed="$itemIconClosed"
                        :iconOpen="$itemIconOpen"
                        :open="$itemOpen"
