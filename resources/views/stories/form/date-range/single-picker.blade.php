...
<div style="min-width: 300px; max-width: 600px; margin: 0 auto;">
    ...
    <p class="f-body-1 mt-20">There is also a "<a href="/?path=/story/molecules-form-daterange--dual-pickers" class="underline">dual picker</a>" version, where each input has its own date picker popup.</p>
